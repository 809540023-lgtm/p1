      ...
      <section class="hero">
        <div class="hero-grid">
          <div>
            ...
            <h1>平台入口總覽</h1>
            <p>這個首頁不是單一宣傳頁，而是整個 AI 日語補習班平台的入口中樞。招商、課程、學員、教師、營運、報表與系統檢查，都要在第一眼就看懂、看得到、進得去。</p>
            <p>你可以先依角色找入口，也可以直接從下面的導航地圖，快速知道每個連結負責哪一段營運工作流。</p>
            <div class="meta">
              <span class="chip">招商入口</span>
              <span class="chip">學員教學入口</span>
              <span class="chip">教師授課入口</span>
              <span class="chip">營運管理入口</span>
              <span class="chip">系統檢查入口</span>
            </div>
            <div class="actions">
          ...
          <article class="hero-panel">
            ...
            <h2>今天最適合先從哪裡開始</h2>
            <p>如果你現在不是要逐頁看完整平台，而是要立刻工作，先從這四個入口進去最快。</p>
